...
----> Ans: not a compulsion to handel it in m1. it internally gets propagated.
...
m1() method has to handle that exception ? -----> yes m1 has to handel the exception. and cannot handel it in m2.
 * 
 ------------------------------------------------------------------------------*/
